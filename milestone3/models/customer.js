...
const customerSchema = new mongoose.Schema({
  firstname: {
    ...
    contact: {
      ...
      minlength: [10, 'Minimum contact length is 10 characters'],
      maxlength: [10, 'Maximum contact length is 10 characters'],
    ...
    address: {
        ...
        lowercase: true,
        maxlength: [100, 'Maximum address length is 100 characters'],
        minlength: [3, 'Maximum address length is 3 characters']
